...
int main(int argc, char *argv[])
{
  ...
  char f[30];
  printf("What file would you like to parse? ");
  scanf("%s", f);

  if(strcmp(f, "pokemon") == 0){
    pokemons(0, 0);
  }else if(strcmp(f, "moves") == 0){
    moves(0, 0);
  }else if(strcmp(f, "pokemon_moves") == 0){
    pokemon_moves(0, 0);
  }else if(strcmp(f, "pokemon_species") == 0){
    pokemon_species(0, 0);
  }else if(strcmp(f, "experience") == 0){
    experiences(0, 0);
  }else if(strcmp(f, "type_names") == 0){
    type_names(0, 0);
  }else if(strcmp(f, "pokemon_stats") == 0){
    pokemon_stats(0, 0);
  }else if(strcmp(f, "stats") == 0){
    stats(0, 0);
  }else if(strcmp(f, "pokemon_types") == 0){
    pokemon_types(0, 0);
  }else{
    printf("Unfortunately your input did not match a used file, please rerun.");
  }
  /* print_hiker_dist(); */
